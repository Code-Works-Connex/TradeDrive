...
export default function Footer() {
  ...
  return (
    <Box sx={{ backgroundColor: "#120202", color: "white" }}>
      <Box
        sx={{
      ...
      {/* Footer Bottom Attribution - Horizontal with Link */}
      <Box
        sx={{
          display: "flex",
      ...
      >
        <Typography variant="body2" sx={{ color: "#888" }}>
          © {new Date().getFullYear()} TradeDrive Autos. All rights reserved.
        </Typography>
        <Typography variant="body2" sx={{ color: "#555" }}>
          ...
          <Box
            ...
            target="_blank"
            rel="noopener noreferrer"
            sx={{ color: "#bbb", textDecoration: "underline", display: "inline" }}
          >
            Connex Codeworks Pvt. Ltd.
          </Box>
        </Typography>
      </Box>
