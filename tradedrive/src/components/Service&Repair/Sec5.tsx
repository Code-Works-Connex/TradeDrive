...
export default function Sec5() {
    const [formData, setFormData] = useState<FormData>({
        ...
        date: '',
        description: '',
        category: 'Service & repair', // Default to 'Service & repair'
        status: 'Pending',
        agree: false,
    });
        ...
        try {
            const response = await fetch(API_ENDPOINTS.booking, {
                ...
                body: JSON.stringify({
                    ...
                    category: 'Service & repair', // Hardcode to 'Service & repair'
        ...
        >
            ...
            >
                ...
                <List sx={{ pl: 1 }}>
                    <ListItem sx={{ py: 0.5 }}>
                        <ListItemText
                            primary="• Friendly, experienced mechanics who care about your car."
                            primaryTypographyProps={{ sx: { color: 'black' } }}
                        />
                    </ListItem>
                    <ListItem sx={{ py: 0.5 }}>
                        <ListItemText
                            primary="• Honest advice & clear communication — no unnecessary upsells."
                            primaryTypographyProps={{ sx: { color: 'black' } }}
                        />
                    </ListItem>
                    <ListItem sx={{ py: 0.5 }}>
                        <ListItemText
                            primary="• Fast turnaround to get you back on the road sooner."
                            primaryTypographyProps={{ sx: { color: 'black' } }}
                        />
                    </ListItem>
                    <ListItem sx={{ py: 0.5 }}>
                        <ListItemText
                            primary="• Top-quality parts to protect your investment."
                            primaryTypographyProps={{ sx: { color: 'black' } }}
                        />
                    </ListItem>
                </List>
